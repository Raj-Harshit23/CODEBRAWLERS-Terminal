...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def newalgo(self, game_state):
        ...
        turret_protect_locations = [[11,13],[12,13],[13,13,],[14,13],[15,13],[16,13]]

        extra_supports = [[13,10],[14,10]]

        left_corner = [[0, 13], [1, 13],[2,13], [4, 12], [4, 11],[4,10]]
        # left_ext_corner = [[3,11],[3,12],[3,13]]
        left_diag1 = [[5,9],[6,11],[7,13]]
        left_diag2 = [[7,7],[8,9],[9,11]]
        left_diag3 = [[9,5],[10,7],[11,9]]
        left_diag4 = [[11,3],[12,5],[13,7]]
        left_diag5 = [[13,3],[13,1]]
        
        right_corner = [[27, 13], [26, 13],[25,13], [23, 12], [23, 11],[23,10]]
        # right_ext_corner = [[24,11],[24,12],[24,13]]
        right_diag1 = [[22,9],[21,11],[20,13]]
        right_diag2 = [[20,7],[19,9],[18,11]]
        right_diag3 = [[18,5],[17,7],[16,9]]
        right_diag4 = [[16,3],[15,5],[14,7]]
        right_diag5 = [[14,3],[14,1]]

        # col1 = [[5,13],[5,11],[5,9]]
        # col2 = [[7,13],[7,11],[7,9],[7,7]]
        # col3 = [[9,13],[9,11],[9,9],[9,7],[9,5]]
        # col4 = [[11,13],[11,11],[11,9],[11,7],[11,5],[11,3]]
        # col5 = [[13,10],[13,9],[13,7],[13,5],[13,2],[13,1]]
        # col6 = [[15,10],[15,9],[15,7],[15,5],[15,2],[15,1]]
        # col7 = [[16,13],[16,11],[16,9],[16,7],[16,5],[16,3]]
        # col8 = [[18,13],[18,11],[18,9],[18,7],[18,5]]
        # col9 = [[20,13],[20,11],[20,9],[20,7]]
        # col10 = [[22,13],[22,11],[22,9]]

        upgrade_priorities = [[17,7],[10,7],[15,5],[19,9],[12,5],[6,11],[13,1],[5,9],[9,5],[16,3],[18,5],[7,13],[9,11],[]]

        if game_state.turn_number >= 5:
            for support in extra_supports:
                if game_state.attempt_spawn(SUPPORT, support):
                    break
        ...
        turrets_to_spawn = left_corner +  left_diag1 + left_diag2 + left_diag3 + left_diag4 + left_diag5 + right_corner + right_diag1 + right_diag2 + right_diag3 + right_diag4 + right_diag5
        # to_be_upgraded_max_prio = [[3,12],[24,12],[13,9 ],[8,10],[19,10],[12,6],[15,6],[12,4],[15,4]]
        if game_state.turn_number >= 2 and self.scored_on_locations:
            # self_breach_location = self_breach[0]
            if game_state.turn_number >= 4 and game_state.turn_number % 2 == 0:
                # upgrade 
                for loc in upgrade_priorities:
                    if game_state.attempt_upgrade(loc):
                        break
        ...
        #             break
        #     if upgraded == 0:
        #         for loc in turret_protect_locations:
        #             if game_state.attempt_upgrade(loc):
        #                 break
        ...
        if game_state.turn_number < 2:
            ...
            self.custom_spawn_turret(game_state, left_corner, 0)
        else:
            ...
            for loc in support_locations:
                for unit in game_state.game_map[loc[0],loc[1]]:
                    if unit.stationary and unit.upgraded:
                        ...
                        break
            if number_of_upgraded_supports < 1:
                for loc in support_locations:
                    if game_state.attempt_upgrade(loc):
                        break
                # game_state.attempt_upgrade(support_locations)
        ...
        if len(self.lru_cache.order) > 20:
            # remove 2 where the defence is the strongest
